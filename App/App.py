...
def run():
    ...
    link = '<b>Built with 🤍 by <a href="" style="text-decoration: none; color: #021659;">Vasu G N</a></b>' 
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            Built with 🤍 by 
            <a href="" style="text-decoration: none; color: grey;">Vasu G N</a>  
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            if ad_user == 'admin' and ad_password == 'admin@resume-analyzer':
                ...
                st.success("Welcome Vasu ! Total %d " % values + " User's Have Used Our Tool : )")                
                ...
                query = 'select * from user_feedback'
                plotfeed_data = pd.read_sql(query, connection)                        
                #print(plotfeed_data.shape)
                #print(plotfeed_data.head())
